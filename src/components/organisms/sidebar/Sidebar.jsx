...
const Sidebar = ({ sidebarTitle }) => {
  const activeLink =
    "hover:bg-primary bg-primary hover:text-black px-4 py-2 rounded-l-2xl flex flex-col font-bold";
  const normalLink =
    "hover:bg-primary px-4 py-2 rounded-l-2xl flex flex-col font-bold";
  return (
    <section className="flex flex-col w-[200px] pl-2 h-screen bg-secondary text-white">
